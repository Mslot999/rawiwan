    ...
    return Consumer<CourseProvider>(
      builder: (context, courseProvider, child) {
        return Scaffold(
          ...
          body: courseProvider.purchasedCourses.isEmpty
              ? Center(
                  child: Text(
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final courseId = courseProvider.purchasedCourses[index];
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text('\฿${courseData['coursePrice'].toStringAsFixed(2)}'), 
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
